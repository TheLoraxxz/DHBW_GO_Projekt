...
func testFilterCalendarEntries(t *testing.T) {
	...
	testTermine[4] = NewTerminObj("testTermin5", "test", ds.MONTHLY, testTermin5Starts, testTermin5Ends, false)
...
func testFilterCalendarEntriesEdgeCase(t *testing.T) {
	...
	//Slice mit Testterminen erstellen
	testTermine := make([]ds.Termin, 5)
	testTermine[0] = NewTerminObj("testTermin1", "test", ds.WEEKLY, testTermin1Starts, testTermin1Ends, false)
	testTermine[1] = NewTerminObj("testTermin2", "test", ds.YEARLY, testTermin2Starts, testTermin2Ends, false)
	testTermine[2] = NewTerminObj("testTermin3", "test", ds.MONTHLY, testTermin3Starts, testTermin3Ends, false)

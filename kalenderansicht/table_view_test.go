...
func testFilterCalendarEntriesCorrectAppending(t *testing.T) {
	...
	testTermine = append(testTermine, NewTerminObj("testTermin1", "test", ds.Never, testTermin1, testTermin1, false))
	testTermine = append(testTermine, NewTerminObj("testTermin2", "test", ds.Never, testTermin2, testTermin2, false))
	testTermine = append(testTermine, NewTerminObj("testTermin3", "test", ds.Never, testTermin3, testTermin3, false))
